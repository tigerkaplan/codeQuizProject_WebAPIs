const quizQuestions = [
  ...
  },
  {
    ...
    choices: ["The current function", "The global object", "The object that the function belongs to", "The parent object of the current object"],
  ...
  },
  {
    ...
    choices: ["Adds a new element to the end of an array", "Removes an element from the beginning of an array", "Executes a function once for each element in an array", "Reverses the order of the elements in an array"],
  ...
  },
  {
    ...
    choices: ["for (var i = 0; i < 5; i++)", "for (i = 0; i < 5; i++)", "for (var i = 5; i > 0; i--)", "for (i = 5; i > 0; i--)"],
